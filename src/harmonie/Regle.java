...
public class Regle {
	...
	public boolean interval(int[] tab) {// verifife si les note de chaque
									// table(soprano, alto, tenor, basse) sont
	...
	public boolean enchainement_Note_possible(int[] noteC, int[] noteP) {// verifie si deux
																// note ce
																// suivant sont
																// de le bon
																// interval +-6
	...
	public boolean checkAc(int[] note, int[] ac) {// verifie si l'accord est valide
		if ((note[6] % 7) == (ac[0] % 7)) {
