...
public class HtmlWriter {
	 ...
	 * @param pathLyAb
	 */
	public HtmlWriter(String nom, int nbH, String pathMidSb, String pathLySb, String pathMidAb, String pathLyAb) {
		this.nom = nom;
		this.nbH = nbH;
	 ...
	 * @throws IOException
	 */
	public static void htmlWrite(HtmlWriter[] tab, String path) throws IOException {
	...
	/**
	 * lance les sous programmes qui ecrivent les differentes parties d'un fichier html avec les arguments adequates.
	 * @param tab
	 * @param fw
	 * @throws IOException
	 */
	private static void toHtml(HtmlWriter[] tab,FileWriter fw) throws IOException{
		enTete(fw);
		body(tab,fw);
		fw.write("</html>\n");
	}
	...
	/**
	 * Ecriture du corps du fichier html, lance l'execution de l'ecriture du tableau en html
	 * @param tab
	 * @param fw
	 * @throws IOException
	 */
	private static void body(HtmlWriter[] tab,FileWriter fw) throws IOException{
		fw.write("<body> \n");
		toTab(tab,fw);
		fw.write("</body>\n");
	}
	 ...
	 * @throws IOException
	 */
	private static void toTab (HtmlWriter[] tab,FileWriter fw) throws IOException{
		fw.write("<table>\n");
		...
		for(int i=0;i<tab.length;i++){
			...
			fw.write("<td><a href=\""+tab[i].pathLySb+"\"> "+tab[i].nom+".mid</a></td>");
			fw.write("<td><a href=\""+tab[i].pathMidSb+"\"> "+tab[i].nom+".mid</a></td>");
			fw.write("<td><a href=\""+tab[i].pathLyAb+"\"> "+tab[i].nom+".mid</a></td>");
			fw.write("<td><a href=\""+tab[i].pathMidAb+"\"> "+tab[i].nom+".mid</a></td>");
			fw.write("</tr>\n");
		}
	}
